...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkStmt = $conn->prepare("SELECT id FROM shs_students WHERE email = ?");
    ...
    if ($checkStmt->num_rows > 0) {
        ...
        $stmt->bind_param("sssssss", $firstName, $middleName, $lastName, $email, $strand, $year_lvl, $current_school_year);
        if ($stmt->execute()) {
            $newStudentId = $conn->insert_id;
            $fullName = trim($firstName . ' ' . $lastName);
            logNotification($conn, 'student_registered', 'SHS student <strong>' . htmlspecialchars($fullName, ENT_QUOTES, 'UTF-8') . '</strong> has been registered.');
            header("Location: violation-list-shs.php?student_id=$newStudentId&student_type=shs&registered=1");
            exit();
        } else {
...
<body>
    <div class="icon-back-wrapper top20">
        <a href="shs-list.php" class="icon-back-btn purple" aria-label="Back to Dashboard">
    ...
    <div class="form-box">
        <form id="form" class="globalForm" method="POST" action="">
            ...
            <div>
                <label for="inputStrand"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M400-400h160v-80H400v80Zm0-120h320v-80H400v80Zm0-120h320v-80H400v80Zm-80 400q-33 0-56.5-23.5T240-320v-480q0-33 23.5-56.5T320-880h480q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H320ZM160-80q-33 0-56.5-23.5T80-160v-560h80v560h560v80H160Z"/></svg></label>
                <select name="student_strand" id="student_strand" required>
                    <option value="" disabled selected>Select Student Strand</option>
...
(function(){
    ...
    var cancelRedirect = 'shs_register.php';
    ...
    form.addEventListener('submit', function(e){
        ...
        e.preventDefault();
        var strandSelect = document.getElementById('student_strand');
        ...
        var items = [
            ...
            { label: 'Strand', value: strandSelect.options[strandSelect.selectedIndex] ? strandSelect.options[strandSelect.selectedIndex].text : '' },
