...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($violations)) {
        ...
        $check_existing_violations_stmt = $conn->prepare("SELECT COUNT(*) as existing_count FROM college_violations WHERE student_id = ? AND school_year_id = ?");
        ...
        $stmt = $conn->prepare("INSERT INTO college_violations (student_id, violation_type, description, school_year_id, semester_id, date_recorded) VALUES (?, ?, ?, ?, ?, NOW())");
...
<head>
    ...
    <title>College Violation Selection</title>
        ...
        <div class="violation-options">
            <div class="violation-card">
                ...
                <ul>
                    ...
                    <li>ot wearing of proper uniform</li>
                    <li>no ID</li>
                </ul>
                <input type="checkbox" name="violations[]" value="Improper School Uniform" id="improper_school_uniform" class="violation-checkbox" onchange="selectViolation('improper_school_uniform')">
            ...
            <div class="violation-card">
                ...
                <input type="checkbox" name="violations[]" value="Improper PE Uniform" id="improper_pe_uniform" class="violation-checkbox" onchange="selectViolation('improper_pe_uniform')">
                <label for="improper_pe_uniform" class="violation-label">Select Violation</label>
            </div>

            <div class="violation-card">
                <h4>Improper Attire</h4>
                <ul>
                    <li>Not following the proper dress code</li>
                    <li>Not wearing NST shirt</li>
                    <li>no ID</li>
                </ul>

                <input type="checkbox" name="violations[]" value="Improper Attire" id="improper_attire" class="violation-checkbox" onchange="selectViolation('improper_attire')">
                <label for="improper_attire" class="violation-label">Select Violation</label>
            </div>

            <div class="violation-card">
                <h4>Earrings (Boys)</h4>
                <p>Wearing of earrings</p>
                <input type="checkbox" name="violations[]" value="Earings (Boys)" id="earrings_boys" class="violation-checkbox" onchange="selectViolation('earrings_boys')">
            ...
            <div class="violation-card">
                ...
                <input type="checkbox" name="violations[]" value="Piercings (Girls)" id="piercings_girls" class="violation-checkbox" onchange="selectViolation('piercings_girls')">
            ...
            <div class="violation-card">
                ...
                <input type="checkbox" name="violations[]" value="Late" id="late" class="violation-checkbox" onchange="selectViolation('late')">
